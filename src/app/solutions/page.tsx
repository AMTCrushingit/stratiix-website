...
const sectors = [
  {
    id: 'home-services',
    name: 'Home Services',
    headline: 'Built for home service businesses ready to scale beyond the founder.',
    body: 'As home service businesses grow, complexity often outpaces the systems supporting the business. Decisions become concentrated, teams become dependent, and operational consistency becomes harder to maintain. The Transformation Operating System™ helps build the capability, leadership infrastructure, and operating discipline required to scale with confidence.',
    challenges: [
      'Founder-dependent operations that cannot scale',
      'Inconsistent service quality across teams',
      'Limited visibility into job costing and margins',
      'Workforce development and retention challenges',
      'Reactive scheduling, dispatch, and field operations',
    ],
